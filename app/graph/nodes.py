...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    " DABS codes (e.g. KR011A200005X8), DABS/종목/건물"
    " proper names (e.g. '북촌 월하재', '역삼 한국빌딩'),"
    " member IDs, emails, person names, addresses,"
    " and specific dates or amounts. Never embed these"
    " raw identifiers in `query` — doing so pollutes"
    " both the schema RAG search and the domain"
    " knowledge retrieval.\n"
    "  Example: user asks '북촌 월하재(KR011A200005X8)를"
    " 청약한 멤버 목록' → call text_to_sql_tool with"
