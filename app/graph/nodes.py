...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    " values (DABS codes like KR011A200005X8, member IDs,"
    " emails, specific dates, person names, addresses)"
    " into the `literals` list. Never embed these raw"
    " identifiers in `query` — doing so pollutes the"
    " schema RAG search.\n"
